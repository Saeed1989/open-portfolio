...

  {
    ...
    content: {
      items: [
        ...
        /*
         * Real public Credly badges, belonging to other people.
         *
         * An invented id cannot stand in here: Credly answers an unknown badge
         * with HTTP 200 and an empty body, so the frame builds correctly and
         * renders nothing — indistinguishable from a broken integration. These
         * two resolve, so the preview shows what the section actually looks
         * like. Swap in your own; the title and issuer beside the frame are the
         * tenant's own text and have to be edited to match.
         */
        {
          id: 'credly-8e5bf237-ba22-4682-be1b-bc96a9bd39c3',
          type: 'certification',
          source: 'credly',
          title: 'AWS Certified Cloud Practitioner',
          issuer: 'Amazon Web Services Training and Certification',
          date: '2025',
          credlyBadgeId: '8e5bf237-ba22-4682-be1b-bc96a9bd39c3',
          verifyUrl:
            'https://www.credly.com/badges/8e5bf237-ba22-4682-be1b-bc96a9bd39c3',
        },
        {
          id: 'credly-e3ef1c7d-9c7f-4c53-97cd-e1dc75d243da',
          type: 'certification',
          source: 'credly',
          title: 'AWS Certified Solutions Architect – Associate',
          issuer: 'Amazon Web Services Training and Certification',
          date: '2024',
          credlyBadgeId: 'e3ef1c7d-9c7f-4c53-97cd-e1dc75d243da',
          verifyUrl:
            'https://www.credly.com/badges/e3ef1c7d-9c7f-4c53-97cd-e1dc75d243da',
        },
      ],
